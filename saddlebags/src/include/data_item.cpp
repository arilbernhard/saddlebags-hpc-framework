...
class Item {
    ...
    // Create a buffer for ordering messages in
    // Pre-creating the buffer is required, because messages are placed directly into the index indicated by its seqnum
    ...
    //Add incoming message to buffer of this item
    ...
    //Call the returning_pull method for all messages in the returning pull buffer
    ...
    //Call the foreign_push method for all messages in the incoming push buffer
