...
Expressiveness features are difficult to quantify, and is in this comparison presented through observation of code examples and design overviews. The findings are shown in table \ref{table:programmability}.
...
\begin{table}[b!]
	...
	\begin{tabular}{ | p{4cm} | p{3.5cm} | p{3.5cm} | p{3.5cm} |}
		...
		Implicit distribution of data & Yes & Yes & Yes \\ \hline
		Message types & push/pull & push/pull & push/pull \\ \hline
		Payload of messages &Return values of methods  & One common data element & Per-application definition of in/out streams\\ \hline
		Ordering of messages & Available, for pulls & No & No \\ \hline
		Computation code & In item, in multiple stages, in methods & In vertex, in one stage, in method & Defined in main program, iterating over vertices \\ \hline
		Terminate on convergence & No & Yes (explicit in task) & No \\ \hline
		Adjacent vertices & Per-application & Yes & Per-application \\ \hline
	\end{tabular}
